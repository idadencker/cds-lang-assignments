...
## Concent of folders: 
The feature_extracted_object folder contain the scipy sparse csr matrix for the vecotrized data
The out folder contains the 2 classification reports
The models folder contains the 2 trained models as well as the TF-IDF vectorizer
The src folder contains 3 scripts: 1 for vectorizing data, 1 for training and evaluation the Neural Network model and 1 for for training and evaluation the logistic regression model
